...
LISTING_URL = "https://www.habitaclia.com/viviendas-igualada.htm?pmax=300000" # https://www.habitaclia.com/viviendas-igualada.htm?pmax=180000&codzonas=4,2
...
def scrape(limit=None):
    ...
    with tqdm(desc="Scraping listings", unit="property") as pbar:
        while current_url:
